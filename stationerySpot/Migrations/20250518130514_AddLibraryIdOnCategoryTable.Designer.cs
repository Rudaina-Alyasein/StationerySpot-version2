...
namespace stationerySpot.Migrations
{
    ...
    [Migration("20250518130514_AddLibraryIdOnCategoryTable")]
    partial class AddLibraryIdOnCategoryTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("stationerySpot.Models.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("stationerySpot.Models.PaymentMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("stationerySpot.Models.Project", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("stationerySpot.Models.Address", b =>
                {
                    b.HasOne("stationerySpot.Models.User", "User")
                        .WithOne("Address")
                        .HasForeignKey("stationerySpot.Models.Address", "UserId")
            ...
            modelBuilder.Entity("stationerySpot.Models.PaymentMethod", b =>
                {
                    b.HasOne("stationerySpot.Models.User", "User")
                        ...
                        .HasForeignKey("stationerySpot.Models.PaymentMethod", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
