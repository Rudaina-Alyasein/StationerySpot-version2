...
namespace stationerySpot.Migrations
{
    ...
    [Migration("20250404172927_AddLibraryNewFields")]
    partial class AddLibraryNewFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("stationerySpot.Models.ContactU", b =>
                {
                    ...
                    b.HasOne("stationerySpot.Models.Library", "Target")
                        .WithMany("ContactUs")
                        .HasForeignKey("TargetId")
                        .HasConstraintName("FK__ContactUs__Targe__17F790F9");
